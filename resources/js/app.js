...
document.addEventListener('DOMContentLoaded', function () {
     ...
     *
     * Vola sa pri kliknutí na tlačidlo "Filtrovať" v index.blade.php
     * Vytvorí URL query string z hodnôt inputov a pošle AJAX request na server
     * Vratí partial HTML s filtrovanými príspevkami a nahradí ich v #postList
     */
    ...
    if (filterBtn && postList) {
        filterBtn.addEventListener('click', function () {
            ...
            // Voláme AJAX request na server s query stringom
